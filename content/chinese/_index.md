...
原项目是两套独立的内容：英文站是一本**仍在写作中**的性能工程书《现代硬件上的算法》（第一部分 12 章成文 69 篇，第二、三、四部分主体未写）；俄文站是四套课程材料（经典算法、数学、机器学习、深度学习）。两条线无内容重叠。

| 分册 | 来源 | 原文状态 | 中文进展 |
|---|---|---|---|
| [现代硬件上的算法](hpc)（HPC） | 英文 | 写作中（第一部分 69 篇已发布） | **翻译中**：第 1–2 章已完成（复杂度模型、计算机体系结构） |
| [算法](cs)（CS） | 俄文 | 已发布 119 篇 | 计划中 |
| [数学](math)（Math） | 俄文 | 已发布 53 篇 | 计划中 |
| [机器学习](ml)（ML） | 俄文 | 已发布 29 篇 | 计划中 |
| [深度学习](dl)（DL） | 俄文 | 已发布 31 篇 | 计划中 |

> 详细的章节清单、完成状态与里程碑见仓库根目录的 [`PLAN.md`](https://github.com/dp9u0/algorithmica/blob/master/PLAN.md)。
